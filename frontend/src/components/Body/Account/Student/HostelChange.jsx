...
function HostelChange() {
  ...
  useEffect(() => {
    fetch("/student/hostel/book/" + hostelId)
      .then((response) => {
        response.json().then((resp) => {
          ...
          for (let i = 0; i < allocations.length; i++) {
            ...
            let room_number = allocations[i].room_no;
    ...
    <div className="container-fluid mb-5">
      <div className="bg-secondary p-3 my-4 mx-4">
        {rooms ? (
          <div>
            <center>
              <h2 className="text-white">Select Your Room</h2>
            </center>
            <div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className={
                                beds
                                  ? "btn btn-sm btn-success col-8"
                                  : "btn btn-sm btn-secondary col-8"
                              }
                              disabled={!beds}
