        ...
        <div className='row justify-content-evenly'>
          ...
          <Card className='bg-dark cards col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
            ...
            <Card.Body>
              ...
              <Button as={Link} to="hostels" variant="success" className="d-grid">hostel list</Button>
            </Card.Body>
          </Card>
          ...
          <Card className='bg-dark cards col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
            ...
            <Card.Body>
              ...
              <Button as={Link} to="addHostel" variant="success" className="d-grid">Add Hostel</Button>
            </Card.Body>
          </Card>
          ...
          <Card className='bg-dark cards col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
            ...
            <Card.Body>
              ...
              <Button as={Link} to="delHostel" variant="success" className="d-grid">delete Hostel</Button>
            </Card.Body>
          </Card>
          ...
          <Card className='bg-dark cards col-lg-4 col-md-6 col-sm-6 col-12 mb-5'>
            ...
            <Card.Body>
              ...
              <Button as={Link} to="editHostel" variant="success" className="d-grid">Edit Hostel</Button>
            </Card.Body>
          </Card>
